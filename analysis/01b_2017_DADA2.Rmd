---
title: "Infer ASVs with DADA2 - 2017 samples"
...
knitr::opts_chunk$set(echo = TRUE,
                      fig.align = "center",
                      fig.path = "../figures/01_DADA2/2017/") 
...
About 25 percent of reads are retained when maxEE = 1. 
Quality control plots look good. For the reverse reads, there are more reads with quality scores lower than 30. They occur after 150 bp. 
...
```{r generate-raw-ASV-table, fig.width=3.5, fig.height=3}
...
write.table(asv_tab, "data/01_DADA2/06_2017_analysis/ASV_counts.tsv", sep = "\t", quote = FALSE, col.names = NA)
# Write count table with ASV sequence names
write.table(noChimeras_ASV_table, "data/01_DADA2/06_2017_analysis/ASV_counts_withSeqNames.tsv", sep = "\t", quote = FALSE, col.names = NA)
# Write out the fasta file for reference later on for what seq matches what ASV
asv_fasta <- c(rbind(asv_headers, asv_seqs))
# Save to a file!
write(asv_fasta, "data/01_DADA2/06_2017_analysis/ASVs.fasta")
...
save(noChimeras_ASV_table, file = "data/01_DADA2/06_2017_analysis/noChimeras_ASV_table.RData")
save(asv_tab, file = "data/01_DADA2/06_2017_analysis/ASV_counts.RData")
...
save(track_counts_df, file = "data/01_DADA2/06_2017_analysis/track_read_counts.RData")
```
