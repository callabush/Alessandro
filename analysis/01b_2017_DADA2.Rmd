...
knitr::opts_chunk$set(echo = TRUE,
                      fig.align = "center",
                      fig.path = "../figures/01_DADA2/04_filtered_fullLength/") 
...
About 24 percent of reads are retained when maxEE = 1. 
About 50 percent of reads are retained when maxEE = 2. 
...
save(track_counts_df, file = "data/01_DADA2/07_fullLength/track_read_counts.RData")
```
