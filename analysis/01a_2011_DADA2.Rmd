---
title: "Infer ASVs with DADA2 - 2011 samples"
...
knitr::opts_chunk$set(echo = TRUE,
                      fig.align = "center",
                      fig.path = "../figures/01_DADA2/2011/") #Send any figure output to this folder
```
...
samples <- scan("/local/workdir/cab565/git_repos/Alessandro/data/00_cutadapt/2011_samples.txt",
                what = "character")
#Intuition check
head(samples)
...
write.table(asv_tab, "data/01_DADA2/Alessandro_2011/ASV_counts.tsv", sep = "\t", quote = FALSE, col.names = NA)
# Write count table with ASV sequence names
write.table(noChimeras_ASV_table, "data/01_DADA2/Alessandro_2011/ASV_counts_withSeqNames.tsv", sep = "\t", quote = FALSE, col.names = NA)
# Write out the fasta file for reference later on for what seq matches what ASV
asv_fasta <- c(rbind(asv_headers, asv_seqs))
# Save to a file!
write(asv_fasta, "data/01_DADA2/Alessandro_2011/ASVs.fasta")
...
save(noChimeras_ASV_table, file = "data/01_DADA2/Alessandro_2011/noChimeras_ASV_table.RData")
save(asv_tab, file = "data/01_DADA2/Alessandro_2011/ASV_counts.RData")
...
save(track_counts_df, file = "data/01_DADA2/Alessandro_2011/track_read_counts.RData")
```
